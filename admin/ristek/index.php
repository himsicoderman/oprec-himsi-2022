...
<head>
    ...
    <title>Dashboard | Admin RISTEK 2022</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="akademik-tab" data-bs-toggle="tab" href="#akademik" role="tab"
