...
<head>
    ...
    <title>Dashboard | Admin PMB 2022</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="seni-tab" data-bs-toggle="tab" href="#seni" role="tab"
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="seni" role="tabpanel" aria-labelledby="seni-tab">
                                        <h1 class='mt-4'>
