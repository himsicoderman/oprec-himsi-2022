...
<head>
    ...
    <title>Dashboard | Admin MEDINFO 2022</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="humas-tab" data-bs-toggle="tab" href="#humas" role="tab"
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="humas" role="tabpanel" aria-labelledby="humas-tab">
                                        <h1 class='mt-4'>
