...
<head>
    ...
    <title>Dashboard | Admin KASTRAD 2022</title>
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="semua-tab" data-bs-toggle="tab" href="#semua" role="tab"
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="kastrad-tab" data-bs-toggle="tab" href="#kastrad" role="tab"
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="kastrad" role="tabpanel" aria-labelledby="kastrad-tab">
                                        <h1 class='mt-4'>
                            ...
                            <div class="card-body">
                                <table class="table table-striped" id="table1" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        $level = 'Kastrad';
                                        $peserta = mysqli_query($koneksi, "SELECT * from regis WHERE pil1 LIKE '%$level%' OR pil2 LIKE '%$level%' ");
                                        $no = 1;
