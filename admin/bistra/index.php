...
<head>
    ...
    <title>Dashboard | Admin BISTRA 2022</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="bistra-tab" data-bs-toggle="tab" href="#bistra" role="tab"
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="bistra" role="tabpanel" aria-labelledby="bistra-tab">
                                        <h1 class='mt-4'>
